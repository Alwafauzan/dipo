ALTER PROCEDURE dbo.xsp_application_asset_insert
(
...
begin
	...
	--		,currency_code
	--		,facility_code
	--		,is_simulation -- (+) Ari 2023-12-01 ket : add checking
	--from	dbo.application_main
	--where	application_no							= '0000312.4.01.11.2023' ;
	...
	begin try
		...
		--(+)-fauzan ngapus cursor di atas
		BEGIN
		    				exec ifinams.dbo.xsp_asset_update_rental_status @p_code				= @code
																			,@p_rental_reff_no	= @p_application_no
																			,@p_rental_status	= 'RESERVED'
																			,@p_reserved_by		= null
																			,@p_is_cancel		= '0'
																			,@p_mod_date		= @p_mod_date

BEGIN TRANSACTION 
DECLARE     @AGREEMENT_NO VARCHAR(20) = '0000446/4/10/04/2022'
...
UPDATE AGREEMENT_ASSET SET ASSET_STATUS = 'TERMINATE' WHERE AGREEMENT_NO = replace(@AGREEMENT_NO,'/','.')
UPDATE AGREEMENT_MAIN SET AGREEMENT_STATUS = 'TERMINATE' WHERE AGREEMENT_NO = replace(@AGREEMENT_NO,'/','.')
